...
def chart_narrative(
    ...
    messages = build_chart_narrative_messages(
    ...
    def generate():
        ...
        try:
            ...
            yield _sse({"type": "error", "content": "Could not generate narrative. Please try again."})
        finally:
            yield _sse({"type": "done"})
